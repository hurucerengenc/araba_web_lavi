          ...
          <div className="app-wrapper">
            ...
            <section className="best-class-section" id="araclar">
              <div className="best-class-container">
                ...
                <div className="best-class-text">
                  ...
                  <h2>Sınıfının <br /> En İyisiyle <br /> Seyahat Edin</h2>
                  <p>Maybach dönüşümüyle benzersiz bir lüks kabine kavuşan Mercedes V-Serisi, 7 yolcuya kadar ağırladığı misafirlerini iş seyahatinin veya özel yolculuğun yorgunluğundan tamamen uzaklaştırır. Her detay özenle tasarlanmıştır.</p>
                  <ul className="features-grid">
                    <li>Masaj Koltukları</li><li>4K Dokunmatik TV</li>
              ...
              <div className="services-grid-main">
                <div className="service-card large">
                  ...
                  <div className="service-content">
                    ...
                    <a href="#iletisim" className="service-link">REZERVASYON &gt;</a>
                  </div>
                </div>
                <div className="services-right-column">
                  <div className="service-card">
                    ...
                    <div className="service-content">
                      ...
                      <p>ASR Kayseri Havalimanı, ESB Ankara ve tüm Türkiye'deki havalimanlarında kapıdan kapıya karşılama hizmeti.</p>
                      <a href="#iletisim" className="service-link">REZERVASYON &gt;</a>
                    </div>
                  </div>
                  <div className="service-card">
                    ...
                    <div className="service-content">
                      ...
                      <p>Şirketler, toplantılar ve kurumsal misafirleriniz için yüksek standartlarda VIP transfer hizmetleri.</p>
                      <a href="#iletisim" className="service-link">REZERVASYON &gt;</a>
                    </div>
                  </div>
                  <div className="service-card">
                    ...
                    <div className="service-content">
                      ...
                      <p>Kayseri, Ankara, İstanbul, Nevşehir ve tüm Türkiye genelinde konforlu uzun yol hizmeti.</p>
                      <a href="#iletisim" className="service-link">REZERVASYON &gt;</a>
                    </div>
                  </div>
                </div>
              ...
              <div className="interior-container">
                ...
                <div className="interior-text-content">
                  ...
                  <p className="interior-desc">
                    Özel konvertif Mercedes Maybach V-Serisi kabinimiz, uçuş konforu ve otel zarafetini buluşturur. Amber aydınlatma, yumuşak deri yüzeyler ve ileri teknoloji donanım — her transfer bir dinlenme deneyimidir.
                  </p>
            ...
            <section className="gallery-section" id="galeri">
              <div className="gallery-header">
                ...
                <h2>Her Karedeki <br /> Zarafet</h2>
              </div>
              <div className="gallery-grid">
                <div className="gallery-item large"><img src={galeri1} alt="Galeri 1" className="gallery-img" /></div>
                <div className="gallery-item"><img src={galeri2} alt="Galeri 2" className="gallery-img" /></div>
                <div className="gallery-item"><img src={galeri3} alt="Galeri 3" className="gallery-img" /></div>
                <div className="gallery-item"><img src={galeri4} alt="Galeri 4" className="gallery-img" /></div>
                <div className="gallery-item"><img src={galeri5} alt="Galeri 5" className="gallery-img" /></div>
                <div className="gallery-item full"><img src={galeri6} alt="Galeri 6" className="gallery-img" /></div>
              </div>
            </section>
            ...
            <footer className="footer">
              <div className="footer-grid">
                ...
                <div><h4>HİZMETLER</h4><p>Transfer / Tur</p></div>
